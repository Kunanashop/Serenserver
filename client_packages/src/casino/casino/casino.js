...
mp.events.add('spin_wheel', function(tb, needSpins, endTable, endBall){
	...
	setTimeout(function () {
		ballSoundID[tb] = mp.game.invoke("0x430386FE9BF80B45");
		mp.game.audio.releaseSoundId(ballSoundID[tb]);
        mp.game.audio.playSoundFromEntity(ballSoundID[tb], "DLC_VW_ROULETTE_BALL_LOOP", RouletteTables[tb].ball.handle, "dlc_vw_table_games_sounds", true, 0);
    }, 8000);
    setTimeout(
		function()
		{
