...
global.needped[4] = mp.peds.new(0xC54E878A, new mp.Vector3(-1265.9005, -1469.4127, 4.3275348), -146, 0); 
...
mp.events.add("loadPage5", (page, json, json2, json3) => {
	...
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[4].handle, 'GENERIC_HI', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
...
mp.events.add("closeMarketMenu5", () => {
	...
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[4].handle, 'GENERIC_BYE', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
});
...
mp.events.add("sellgreat5", () => {
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[4].handle, 'GENERIC_THANKS', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
});