...
global.needped[2] = mp.peds.new(0x94562DD7, new mp.Vector3(-1269.5475, -1483.5403, 4.3436161), -64, 0); 
...
mp.events.add("loadPage", (page, json, json2, json3) => {
	...
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[2].handle, 'GENERIC_HI', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
...
mp.events.add("closeMarketMenu", () => {
	...
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[2].handle, 'GENERIC_BYE', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
});
...
mp.events.add("sellgreat1", () => {
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[2].handle, 'GENERIC_THANKS', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
});
