...
global.needped[1] = mp.peds.new(0xAD9EF1BB, new mp.Vector3(-1231.9276, -1509.184, 4.37360548), -61.9535, 0); 
...
mp.events.add("loadPage3", (page, json, json2, json3) => {
	...
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[1].handle, 'GENERIC_HI', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
...
mp.events.add("closeMarketMenu3", () => {
	...
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[1].handle, 'GENERIC_BYE', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
});
...
mp.events.add("sellgreat3", () => {
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[1].handle, 'GENERIC_THANKS', '', 'SPEECH_PARAMS_FORCE_SHOUTED', !1);
});
