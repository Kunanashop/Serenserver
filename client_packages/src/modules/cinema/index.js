...
mp.events.add("enterCinema", () => {
	...
	{
		mp.game.cam.doScreenFadeOut(500);
		global.localplayer.setVelocity(0.0, 0.0, 0.0);
...
mp.events.add("exitCinema", () => {
	...
	setTimeout(function() {	
		...
		// global.localplayer.position = new mp.Vector3(cinema_exit_here[0], cinema_exit_here[1], cinema_exit_here[2]);
		// global.localplayer.setHeading(cinema_exit_here[3]);
