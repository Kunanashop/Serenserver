...
global.needped[3] = mp.peds.new(0xE3420BDB, new mp.Vector3(-1262.4504, -1465.0596, 4.4074522), -57, 0); 
...
mp.events.add("loadPage6", (page, json, json2, json3) => {
	...
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[3].handle, 'GENERIC_HI', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
...
mp.events.add("closeMarketMenu6", () => {
	...
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[3].handle, 'GENERIC_BYE', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
});
...
mp.events.add("sellgreat6", () => {
	mp.game.audio.playAmbientSpeechWithVoice(global.needped[3].handle, 'GENERIC_THANKS', '', 'SPEECH_PARAMS_FORCE_SHOUTED', false);
});
